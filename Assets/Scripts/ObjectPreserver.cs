...
using UnityEngine.SceneManagement;
    ...
    // All credits for this script goes to this Unity forum post:
...
public class ObjectPreserver : MonoBehaviour
{
    ...
    void CheckForDuplicateInstances()
    {
        ...
        ObjectPreserver[] collection = FindObjectsOfType<ObjectPreserver>();

        // iterate through the objects with this component, deleting those with matching identifiers
        foreach (ObjectPreserver obj in collection)
        {
